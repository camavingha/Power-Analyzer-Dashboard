...
if __name__ == "__main__":
    # config = [
    #     {"function_code": 0x03, "register": 0x0104, "num_registers": 0x0002, "label": "Total Time"},
    #     {"function_code": 0x04, "register": 0x0578, "num_registers": 0x0002, "label": "Serial Number of Meter"},
    #     {"function_code": 0x04, "register": 0x0640, "num_registers": 0x0002, "label": "Modbus ID"},
    #     {"function_code": 0x04, "register": 0x003C, "num_registers": 0x0002, "label": "Frequency"},
    ...
    #     {"function_code": 0x04, "register": 0x0004, "num_registers": 0x0002, "label": "L1 Active Power"},
    #     {"function_code": 0x04, "register": 0x0010, "num_registers": 0x0002, "label": "L2 Active Power"},
    #     {"function_code": 0x04, "register": 0x0024, "num_registers": 0x0002, "label": "L3 Active Power"},
    #     {"function_code": 0x04, "register": 0x0030, "num_registers": 0x0002, "label": "Active Three-phase Power"},
    #     {"function_code": 0x04, "register": 0x0036, "num_registers": 0x0002, "label": "Apparent Three-phase Power"},
    #     {"function_code": 0x04, "register": 0x0002, "num_registers": 0x0002, "label": "L1 Current"},
    #     {"function_code": 0x04, "register": 0x0010, "num_registers": 0x0002, "label": "L2 Current"},
    #     {"function_code": 0x04, "register": 0x0020, "num_registers": 0x0002, "label": "L3 Current"}
    # ]
    config = [
        ...
        {"function_code": 0x04, "register": 0x0030, "num_registers": 0x0002, "label": "L1 Frequency"},
